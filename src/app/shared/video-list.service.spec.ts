...
describe('Service: VideoList', () => {
  ...
  it('should get videos', () => {
    ...
    // assert:
    const expectedUrl = 'https://www.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&chart=mostPopular&maxResults=5&key=AIzaSyBzcxTIAnAie2aFS_BD2KuXncrwChVLNDQ';
